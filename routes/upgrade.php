...
Route::get('upgrade/database', function () {
    if (config('app.upgrade_mode')) {
        ...
        echo "Your database upgraded successfully, you can disable upgrade mode from your .env file (UPGRADE_MODE=false))";
    } else {
        echo "Your upgrade settings are disabled, you can enable it from your .env file (UPGRADE_MODE=true))";
    }
});
