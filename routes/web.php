...
use App\Http\Controllers\RcardController;
...
Route::middleware('auth', 'valid.user')->group(function () {
	...
	Route::prefix('admin')->middleware('role:admin')->group(function () {
		...
		Route::middleware('multi_tenant')->group(function () {
			...
			Route::middleware('subscription')->group(function () {
				...
				//rcard
				Route::resource('/rcards', RcardController::class);
				//vcard
				Route::get(
	...
	Route::prefix('sadmin')->middleware('role:super_admin')->group(function () {
		...
		//rcard
		Route::get('/rcards', [RcardController::class, 'index'])->name('sadmin.rcards.index');
		//affiliate Users
...
Route::post(
	'{alias}/contact/appointment/store',
	[ScheduleAppointmentController::class, 'store']
)->name('appointment.store.vcard11');
...
Route::get('qr-code/examples/url', function () {
	return \LaravelQRCode\Facades\QRCode::url('werneckbh.github.io/qr-code/')
		->setSize(8)
		->setMargin(2)
		->png();
});
