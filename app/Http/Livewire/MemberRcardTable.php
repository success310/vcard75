...
class MemberRcardTable extends LivewireTableComponent
{
    ...
    {
        return [
            Column::make(__('messages.rcard.rcard_name'), 'name')
                ->sortable()->searchable(),
            Column::make(__('messages.rcard.preview_url'), 'preview_url'),
            Column::make(__('messages.rcard.preview_url'), 'url_alias')
                ->hideIf('url_alias')
                ->searchable(),
            Column::make(__('messages.rcard.stats'), 'stats'),
            Column::make(__('messages.rcard.status'), 'first_name')
                ->sortable(),
            Column::make(__('messages.rcard.created_at'), 'created_at')->sortable(),
    ...
    public function render()
    {
        ...
        return view('livewire-tables::'.config('livewire-tables.theme').'.datatable')
            ->with([
                ...
                'componentName' => 'rcards.add-button',
                'makeVcard' => $makeVcard,
            ]);
    }

    public function resetPageTable($pageName = 'member-rcard-table')
    {
