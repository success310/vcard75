...
class MemberTable extends LivewireTableComponent
{
    ...
    {
        return [
            Column::make(__('messages.user.full_name'), 'first_name')->sortable()
    ...
    {
        return User::role('user')->with(['media', 'subscriptions.plan'])->where('id', '!=', getLogInUserId());
    }
