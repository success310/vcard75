    ...
    <div class="container p-0">
        ...
        <div class="vcard-three main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
            ...
            <div class="vcard-three__profile-details py-3 px-3">
                ...
                <span
                    class="profile-designation text-center d-block text-white">{{ ucwords($vcard->occupation) }}</span>
                <div class="mt-5">
                                ...
                                <div
                                    ...
                                    <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                        <h6 class="text-white text-sm-start text-center">
                                            {{ __('messages.vcard.email_address') }}</h6>
                        ...
                        @if ($vcard->alternative_email)
                            <div class="col-sm-6 col-12">
                                <div
                                    class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                                    <span class="event-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard3/alter-email.png') }}" alt="email"
                                            height="21" width="28" />
                                    </span>
                                    <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                        <h6 class="text-white text-sm-start text-center">
                        ...
                        @if ($vcard->alternative_phone)
                            <div class="col-sm-6 col-12">
                                <div
                                    class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                                    <span class="event-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard3/old-typical-phone-vcard-3.png') }}"
                                            alt="phone" />
                                    </span>
                                    <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                        <h6 class="text-white text-sm-start text-center">
            ...
            @if (checkFeature('gallery') && $vcard->gallery->count())
                <div class="vcard-three__gallery mt-3 py-3 position-relative px-3 mb-10 mt-0">
                    <h4 class="vcard-three-heading heading-line text-center pb-4 text-white">
            ...
            @if (checkFeature('products') && $vcard->products->count())
                <div class="vcard-three__product mt-3 py-3 position-relative px-3 mb-10 mt-0">
                    <h4 class="vcard-three-heading heading-line text-center pb-4 text-white">
                                ...
                                <div class="col-12 h-100">
                                    <div class="card testimonial-card p-3 border-0 h-100">
                                        <div
                                            ...
                                            <div class="user-details d-flex justify-content-center flex-column ms-sm-3 mt-sm-0 mt-2 h-100">
                                                <span
            ...
            @if (checkFeature('blog') && $vcard->blogs->count())
                <div class="vcard-three__blog py-3 mb-10 mt-0">
                    <h4 class="vcard-three-heading heading-line position-relative text-center pb-4">
            ...
            <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                @if (empty($userSetting['hide_stickybar']))
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('add-contact', $vcard->id) }}"
                            class="text-white vcard-btn-group vcard3-sticky-btn rounded-0 px-2 ps-5 py-1"><i
                                class="fas fa-download download-icon fs-4"></i></a>
                        <div class="spinner-border fs-1 d-none" role="status" style="width: 25px; height: 25px;">
                            <span class="visually-hidden">Loading...</span>
                        </div>
                        </button>
                        <button type="button"
                            class="vcard3-share share-btn vcard-btn-group vcard3-sticky-btn rounded-0 px-2 py-1"><i
                                class="fas fa-share-alt fs-4"></i></button>
                        @if (!empty($userSetting['enable_affiliation']))
                            <button type="button"
                                class="vcard-btn-group vcard3-sticky-btn rounded-0 px-2 py-1 copy-referral-btn"
                                data-id="{{ $vcard->user->affiliate_code }}"><i
                                    class="fa-regular fa-copy fs-4"></i></button>
                        @endif
                        @if ($vcard->enable_download_qr_code)
                            <a type="button"
                                class="vcard-btn-group vcard3-sticky-btn rounded-0 px-2 pe-5 py-2 text-white"
                ...
                @if (!empty($userSetting['enable_contact']))
                    <a href="{{ route('add-contact', $vcard->id) }}"
                        class="vcard3-sticky-btn add-contact-btn d-flex justify-content-center ms-8 text-white align-items-center rounded-0 px-5 text-decoration-none py-1 rounded-pill justify-content-center ">{{ __('messages.setting.add_contact') }}</a>
                @endif
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 justify-content-between social-link-modal">
                                <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}" target="_blank"
                                    class="mx-2 share3" title="Facebook">
                                ...
                                <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                    class="mx-2 share3" title="Whatsapp">
