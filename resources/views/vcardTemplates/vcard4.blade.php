    ...
    <div class="container p-0">
        ...
        <div class="main-content vcard w-100 mx-auto content-blur collapse show allSection">
            ...
            <div class="vcard__profile d-flex align-items-center px-4 flex-sm-row flex-column">
                ...
                <div class="vcard__position d-flex flex-column mx-sm-4 mt-sm-5 mt-2">
                    <div class="d-flex flex-column vcard_details">
                        ...
                        <span
                            class="avatar-designation text-sm-start text-center">{{ ucwords($vcard->occupation) }}</span>
                    </div>
                        ...
                        @if ($vcard->alternative_email)
                            <div class="col-sm-6 col-12">
                                <div
                                    class="card vcard__event-card d-flex flex-column justify-content-center align-items-center border-0 p-3 h-100">
                                    <span class="event-icon">
                                        <img src="{{ asset('assets/img/vcard4/alter-image.png') }}" class="img-fluid"
                        ...
                        @if ($vcard->alternative_phone)
                            <div class="col-sm-6 col-12">
                                <div
                                    class="card vcard__event-card d-flex flex-column justify-content-center align-items-center border-0 p-3 h-100">
                                    <span class="event-icon">
                                        <img src="{{ asset('assets/img/vcard4/alter-phone.png') }}"
                                            class="img-fluid">
                                    </span>
            ...
            @if (checkFeature('services') && $vcard->services->count())
                <div class="my-4 px-4 pb-2 position-relative overflow-hidden mb-10 pt-2">
            ...
            @if (checkFeature('blog') && $vcard->blogs->count())
                <div class="vcard__blog py-3 mb-10 mt-0">
                    <h4 class="vcard__heading heading-line position-relative text-center pb-4">
                                    ...
                                    <div class="card blog-card p-2 border-0 w-100 h-100">
                                        ...
                                        <div class="blog-details">
                                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"
                                                ...
                                                <h4 class="text-sm-start text-center title-color text-black p-3 mb-0">
                                                    {{ $blog->title }}</h4>
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                @if (empty($userSetting['hide_stickybar']))
                    <div class="btn-group vcard4-btn-div" role="group" aria-label="Basic example">
                        <a href="{{ route('add-contact', $vcard->id) }}"
                            class="vcard-btn-group vcard4-sticky-btn rounded-0 px-2 ps-5 py-1"><i
                        ...
                        <button type="button"
                            class="vcard4-share vcard-btn-group vcard4-sticky-btn rounded-0 px-2 py-1"><i
                                class="fas fa-share-alt fs-4"></i></button>
                        @if (!empty($userSetting['enable_affiliation']))
                            <button type="button"
                                class="vcard-btn-group vcard4-sticky-btn rounded-0 px-2 py-1 copy-referral-btn"
                                data-id="{{ $vcard->user->affiliate_code }}"><i
                                    class="fa-regular fa-copy fs-4"></i></button>
                        @endif
                        @if ($vcard->enable_download_qr_code)
                            <a type="button"
                                class="vcard-btn-group vcard4-sticky-btn rounded-0 px-2 pe-5 py-2 text-white"
                ...
                @if (!empty($userSetting['enable_contact']))
                    <a href="{{ route('add-contact', $vcard->id) }}"
                        class="vcard4-sticky-btn add-contact-btn d-flex justify-content-center ms-8 text-white align-items-center rounded-0 px-5 text-decoration-none py-1 rounded-pill justify-content-center vcard4-btn-div">{{ __('messages.setting.add_contact') }}</a>
                @endif
            </div>
        </div>
        {{-- share modal code --}}
                        ...
                        <div class="row">
                            <div class="col-sm-12 justify-content-between social-link-modal">
                                <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}" target="_blank"
                                    class="mx-2 share4" title="Facebook">
                                ...
                                <a href="mailto:?Subject=&Body={{ $shareUrl }}" target="_blank" target="_blank"
                                    class="mx-2 share4" title="Email">
                                ...
                                <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                    class="mx-2 share4" title="Whatsapp">
