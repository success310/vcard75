                    ...
                    <div class="container">
                        <div class="row g-3 mb-0 justify-content-center blog-slider overflow-hidden">
                            @foreach ($vcard->blogs as $blog)
                                <div class="col-6 mb-2">
                                    <div
                                        class="card blog-card p-sm-2 p-4 border-0 w-100 h-100 flex-sm-row flex-column">
                                        ...
                                        <div class="blog-details mt-3">
                                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"
                                                ...
                                                <h4 class="text-start text-black p-sm-3 pt-2 mb-0">{{ $blog->title }}
                                                </h4>
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="w-100 d-flex justify-content-center sticky-vcard-div">
            @if (empty($userSetting['hide_stickybar']))
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{ route('add-contact', $vcard->id) }}" class="vcard-btn-group vcard1-sticky-btn text-white rounded-0 px-2 ps-5 py-1"><i
                            class="fas fa-download fs-4"></i></a>
                    <button type="button"
                        class="vcard1-share share-btn vcard-btn-group vcard1-sticky-btn rounded-0 px-2 py-1"><i
                            class="fas fa-share-alt fs-4"></i></button>
                    @if (!empty($userSetting['enable_affiliation']))
                        <button type="button"
                            class="vcard-btn-group vcard1-sticky-btn rounded-0 px-2 py-1 copy-referral-btn"
                            data-id="{{ $vcard->user->affiliate_code }}"><i
                                class="fa-regular fa-copy fs-4"></i></button>
                    @endif
                    @if ($vcard->enable_download_qr_code)
                        <a type="button"
                            class="text-white vcard-btn-group vcard1-sticky-btn rounded-0 px-2 pe-5 py-2"
            ...
            @if (!empty($userSetting['enable_contact']))
                <a href="{{ route('add-contact', $vcard->id) }}"
                    class="vcard1-sticky-btn add-contact-btn d-flex justify-content-center ms-8 text-white align-items-center rounded-0 px-5 text-decoration-none py-1 rounded-pill justify-content-center">{{ __('messages.setting.add_contact') }}</a>
            @endif
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 justify-content-between social-link-modal">
                            <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}" target="_blank"
                                class="mx-2 share" title="Facebook">
                            ...
                            <a href="mailto:?Subject=&Body={{ $shareUrl }}" target="_blank" class="mx-2 share"
                                title="Email">
