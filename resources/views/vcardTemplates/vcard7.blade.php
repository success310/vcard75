            ...
            <div class="main-bg p-0 collapse show allSection">
                ...
                <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                    @if (empty($userSetting['hide_stickybar']))
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="vcard-btn-group vcard7-sticky-btn rounded-0 px-2 ps-5 py-1"><i
                            ...
                            <button type="button"
                                class="vcard7-share vcard-btn-group vcard7-sticky-btn rounded-0 px-2 py-1"><i
                                    class="fas fa-share-alt fs-4"></i></button>
                            @if (!empty($userSetting['enable_affiliation']))
                                <button type="button"
                                    class="vcard-btn-group vcard7-sticky-btn rounded-0 px-2 py-1 copy-referral-btn"
                                    data-id="{{ $vcard->user->affiliate_code }}"><i
                                        class="fa-regular fa-copy fs-4"></i></button>
                            @endif
                            @if ($vcard->enable_download_qr_code)
                                <a type="button"
                                    class="vcard-btn-group vcard7-sticky-btn rounded-0 px-2 pe-5 py-2 text-dark"
                    ...
                    @if (!empty($userSetting['enable_contact']))
                        <a href="{{ route('add-contact', $vcard->id) }}"
                            class="vcard7-sticky-btn add-contact-btn d-flex justify-content-center ms-8 text-dark align-items-center rounded-0 px-5 text-decoration-none py-1 rounded-pill justify-content-center shadow">{{ __('messages.setting.add_contact') }}</a>
                    @endif
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 justify-content-between social-link-modal">
                                <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}" target="_blank"
                                    class="mx-2 share7" title="Facebook">
