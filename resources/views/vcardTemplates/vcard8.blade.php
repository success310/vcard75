    ...
    <div class="container p-0">
        ...
        <div class="vcard-eight main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
                                ...
                                <li class="dropdown1 dropdown lang-list">
                                    ...
                                    <ul class="dropdown-menu start-0 lang-hover-list top-dropdown top-100">
                                        @foreach (getAllLanguage() as $key => $language)
                                            <li
                                                class="{{ getLanguageIsoCode($vcard->default_language) == $key ? 'active' : '' }}">
                ...
                <div
                    ...
                    <div class="vcard-eight__position d-flex flex-column mx-4 position-relative">
                        <div class="d-flex flex-column">
                            ...
                            <span
                                class="avatar-designation text-white text-sm-start text-center">{{ ucwords($vcard->occupation) }}</span>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row g-4">
                                    @if ($vcard->email)
                                        <div class="col-sm-6 col-12">
                                            ...
                                            <div class="event-details">
                                                <span
                                                    class="text-white text-center d-block mb-1">{{ __('messages.vcard.email_address') }}</span>
                                    ...
                                    @if ($vcard->alternative_email)
                                        <div class="col-sm-6 col-12">
                                            <div
                                                class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                                                <img src="{{ asset('assets/img/vcard8/alter-image.png') }}"
                                    ...
                                    @if ($vcard->alternative_phone)
                                        <div class="col-sm-6 col-12">
                                            <div
                                                class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                                                <img src="{{ asset('assets/img/vcard8/alter-phone.png') }}"
                                                    alt="mobile" />
                                            </div>
                                            <div class="event-details">
                                                <span
                                    ...
                                    @if ($vcard->location)
                                        <div class="col-sm-6 col-12">
                                            ...
                                            <div class="event-details">
                                                <span
                                                    class="text-white text-center d-block mb-1">{{ __('messages.vcard.location') }}</span>
            ...
            @if (checkFeature('services') && $vcard->services->count())
                <div class="vcard-eight__service py-4 position-relative px-sm-4 px-3 mb-10 mt-0">
                    <div class="container">
                        <h4
            ...
            @if (checkFeature('gallery') && $vcard->gallery->count())
                <div class="vcard-eight__gallery py-4 position-relative px-sm-4 px-3 mb-10 mt-0">
                    <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
                                        ...
                                        @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                                            <a id="file_url" href="{{ $file->gallery_image }}"
                                                ...
                                                <div class="gallery-item"
                                                    @if ($extension == 'pdf') style="background-image: url({{ asset('assets/images/vcard-file.png') }})"> @endif
            ...
            @if (checkFeature('products') && $vcard->products->count())
                <div class="vcard-eight__product py-4 position-relative px-sm-4 px-3 mb-10 mt-0">
                    <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
            ...
            @if (checkFeature('testimonials') && $vcard->testimonials->count())
                <div class="vcard-eight__testimonial py-4 position-relative px-sm-4 px-3 mb-10 mt-0">
                    <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
                        ...
                        @foreach ($vcard->testimonials as $testimonial)
                            <div class="col-12 h-100">
                                <div class="card testimonial-card p-3 border-0 w-100 h-100">
                                    ...
                                    <p
                                        class="review-message text-center mt-2 mx-auto h-100 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            @if (checkFeature('blog') && $vcard->blogs->count())
                <div class="vcard-eight__blog position-relative py-3 mb-10 mt-0">
                    <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
                                    ...
                                    <div class="card blog-card p-2 border-0 w-100 h-100">
                                        ...
                                        <div class="blog-details">
                                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"
                                                ...
                                                <h4 class="text-sm-start text-center title-color p-3 mb-0 text-white">
                                                    {{ $blog->title }}</h4>
                                            </a>
                                        </div>
                                    </div>
            ...
            @if ($vcard->businessHours->count())
                ...
                @endphp
                <div class="vcard-eight__timing py-4 position-relative px-sm-4 px-sm-3 mb-10 mt-0">
                    <div class="container">
                        <h4
            ...
            @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                <div class="vcard-eight__appointment py-3 px-sm-4 px-3 mt-2 position-relative mb-10 mt-0">
                    <div class="container">
                        <h4
            ...
            <div class="vcard-eight__contact pt-4 position-relative px-sm-4 px-3 ">
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
                        {{ __('messages.contact_us.contact_us') }}</h4>
                                ...
                                <form id="enquiryForm">
                                    ...
                                    <div class="contact-form px-sm-3">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button type="submit"
                                                class="contact-btn text-white mt-4 d-block ms-sm-auto">{{ __('messages.contact_us.send_message') }}
                                            </button>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                    @if (empty($userSetting['hide_stickybar']))
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="vcard-btn-group vcard8-sticky-btn rounded-0 px-2 ps-5 py-1"><i
                                    class="fas fa-download download-icon fs-4"></i></a>
                            <div class="spinner-border fs-1 d-none" role="status"
                                style="width: 25px; height: 25px;"><span class="visually-hidden">Loading...</span>
                            </div>
                            </button>
                            <button type="button"
                                class="vcard8-share vcard-btn-group vcard8-sticky-btn rounded-0 px-2 py-1"><i
                                    class="fas fa-share-alt fs-4"></i></button>
                            @if (!empty($userSetting['enable_affiliation']))
                                <button type="button"
                                    class="vcard-btn-group vcard8-sticky-btn rounded-0 px-2 py-1 copy-referral-btn"
                                    data-id="{{ $vcard->user->affiliate_code }}"><i
                                        class="fa-regular fa-copy fs-4"></i></button>
                            @endif
                            @if ($vcard->enable_download_qr_code)
                                <a type="button"
                                    class="vcard-btn-group vcard8-sticky-btn rounded-0 px-2 pe-5 py-2 text-white"
                    ...
                    @if (!empty($userSetting['enable_contact']))
                        <a href="{{ route('add-contact', $vcard->id) }}"
                            class="vcard8-sticky-btn add-contact-btn d-flex justify-content-center ms-8 text-white align-items-center rounded-0 px-5 text-decoration-none py-1 rounded-pill justify-content-center ">{{ __('messages.setting.add_contact') }}</a>
                    @endif
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" aria-label="Close"
                                class="btn btn-sm btn-icon btn-active-color-danger" data-bs-dismiss="modal">
                            ...
                            <div class="row">
                                <div class="col-sm-12 justify-content-between social-link-modal">
                                    ...
                                    <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                        class="mx-2 share8" title="Whatsapp">
