        ...
        <div class="vcard-two main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
            ...
            <div class="vcard-two__event py-3 px-3">
                ...
                @if ($vcard->alternative_email)
                    <div class="event-details d-flex">
                        <div class="event-image">
                            <img src="{{ asset('assets/img/vcard2/alter-image.png') }}" alt="email" height="20"
                                width="27" />
                        </div>
            ...
            <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                @if (empty($userSetting['hide_stickybar']))
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('add-contact', $vcard->id) }}"
                            class="text-white vcard-btn-group vcard2-sticky-btn rounded-0 px-2 ps-5 py-1"><i
                        ...
                        <button type="button"
                            class="vcard2-share vcard-btn-group vcard2-sticky-btn rounded-0 px-2 py-1"><i
                                class="fas fa-share-alt fs-4"></i></button>
                        @if (!empty($userSetting['enable_affiliation']))
                            <button type="button"
                                class="vcard-btn-group vcard2-sticky-btn rounded-0 px-2 py-1 copy-referral-btn"
                                data-id="{{ $vcard->user->affiliate_code }}"><i
                                    class="fa-regular fa-copy fs-4"></i></button>
                        @endif
                        @if ($vcard->enable_download_qr_code)
                            <a type="button"
                                class="vcard-btn-group vcard2-sticky-btn rounded-0 px-2 pe-5 py-2 text-white"
                ...
                @if (!empty($userSetting['enable_contact']))
                    <a href="{{ route('add-contact', $vcard->id) }}"
                        class="vcard2-sticky-btn add-contact-btn d-flex justify-content-center ms-8 text-white align-items-center rounded-0 px-5 text-decoration-none py-1 rounded-pill justify-content-center">{{ __('messages.setting.add_contact') }}</a>
                @endif
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 justify-content-between social-link-modal">
                                <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}" target="_blank"
                                    class="mx-2 share2" title="Facebook">
                                ...
                                <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                    class="mx-2 share2" title="Whatsapp">
