		...
		<div class="row">
			<div class="col-lg-6">
				<div class="row">
						...
						<div class="col-sm-6 col-12">
							<div class="form-group mb-3">
								{{ Form::label('mobileValidation', __('Phone Number validation').':', ['class' => 'form-label mb-3']) }}
								<label class="form-check form-switch form-switch-sm cursor-pointer">
									<input type="checkbox" name="mobile_validation" class="form-check-input"
									       value="1" {{ $setting['mobile_validation'] == '1' ? 'checked' : '' }} id="mobileValidation">
									<span class="form-check-label text-gray-600"
									      for="mobileValidation">{{ __('Enable validation') }}</span>&nbsp;&nbsp;
								</label>
							</div>
						</div>
				</div>
