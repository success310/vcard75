                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div
                                    class="paypal-div {{ !empty($setting['paypal_enable']) == '1' ? '' : 'd-none' }} col-12">
                                    <div class="row">
                                        <div class="form-group col-sm-6 mb-5">
                                    ...
                                    <div class="col-sm-3 col-md-3 mb-3">
                                        <div class="form-group mb-3">
                                            <label for="enable_contact"
                                                class="form-label fs-6 fw-bolder text-gray-700 mb-3">{{ __('messages.setting.enable_contact') }}
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" name="enable_contact" class="form-check-input"
                                                    value="1"
                                                    {{ !empty($setting['enable_contact']) ? 'checked' : '' }}>
                                                <span class="custom-switch-indicator"></span>
                                            </label>
                                        </div>
                                    </div>
