@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li class="nav-item {{ Request::is('sadmin/members*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('members.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-users"></i></span>
            <span class="aside-menu-title">{{ __('messages.members') }}</span>
        </a>
    </li>

    <li class="nav-item {{ Request::is('sadmin/rcard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('sadmin.rcards.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-id-card"></i></span>
            <span class="aside-menu-title">{{ __('messages.rcards') }}</span>
        </a>
    </li>
...
@role(App\Models\Role::ROLE_ADMIN)
    ...
    <li class="nav-item {{ Request::is('admin/staff*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('staff.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-id-card"></i></span>
            <span class="aside-menu-title">{{ __('messages.staff') }}</span>
        </a>
    </li>

    <li class="nav-item {{ Request::is('admin/rcard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('rcards.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-id-card"></i></span>
            <span class="aside-menu-title">{{ __('messages.rcards') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item {{ Request::is('admin/virtual-backgrounds*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page"
            ...
            <span class="aside-menu-icon pe-3"><i class="fas fa-id-card"></i></span>
            <span class="aside-menu-title">{{ __('Virtual Backgrounds') }}</span>
        </a>
    </li>
