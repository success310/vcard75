@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/affiliation-transactions*') ? 'd-none' : '' }}">
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/members*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/members*') ? 'active' : '' }}"
            href="{{ route('members.index') }}">{{ __('messages.members') }}</a>
    </li>

    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/rcards*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/rcards*') ? 'active' : '' }}"
            href="{{ route('members.index') }}">{{ __('messages.rcards') }}</a>
    </li>
...
@role(App\Models\Role::ROLE_ADMIN)
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/virtual-backgrounds*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('admin/virtual-backgrounds*') ? 'active' : '' }}"
            href="{{ route('virtual-backgrounds.index') }}">{{ __('Virtual Backgrounds') }}</a>
    </li>
